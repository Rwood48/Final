#import tkinter, random, and time functions
from tkinter import*
import random
import time
...
#calculator label and button parameters
...
status = Label(f2,font=('aria', 15, 'bold'),width = 16, text="-By Redding Wood",bd=2,relief=SUNKEN)
status.grid(row=7,columnspan=3)

#declare all menus items and labels as string variables
rand = StringVar()
Fries = StringVar()
...
#menu item and label parameters
...
#total, reset, and exit button parameters
